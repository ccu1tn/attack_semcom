...
def parse_args():
    ...
    parser.add_argument("--num_frame", type=int, default=64, help="number of frame in each barch")
    parser.add_argument("--frame_size", type=float, default=0.008, help="time duration of each frame")
    parser.add_argument("--stride_size", type=float, default=0.008, help="time duration of frame stride") 
    
    parser.add_argument("--wav_path", type=str, default="./converted_audio/input_1000audio",
                        help="path of wavset")
    parser.add_argument("--save_path", type=str, default="./output_tfrecords_1000_batch_size16",
